...
class SolMateAPIClient(AsyncSolMateAPIClient):
    ...
    def _request(self, route, data):
        ...
        return self.loop.run_until_complete(super()._request(route, data))
    ...
    def login(self, user_password, device_id=DEFAULT_DEVICE_ID) -> str:
        ...
        return self.loop.run_until_complete(super().login(user_password, device_id))
    ...
    def check_uri(self, auth_token, device_id):
        ...
        self.loop.run_until_complete(super().check_uri(auth_token, device_id))
    ...
    def authenticate(self, auth_token, device_id=DEFAULT_DEVICE_ID):
        ...
        """
        self.loop.run_until_complete(super().authenticate(auth_token, device_id))
    ...
    def quickstart(self, password=None, device_id=DEFAULT_DEVICE_ID):
        ...
        self.loop.run_until_complete(super().quickstart(password, device_id))

    def get_software_version(self):
        """Returns the actually installed software version"""
        return self.loop.run_until_complete(super()._request("get_solmate_info", {}))
    ...
    def get_live_values(self):
        ...
        return self.loop.run_until_complete(super()._request("live_values", {}))
    ...
    def get_recent_logs(self, days=None, start_time=None):
        ...
        return self.loop.run_until_complete(super()._request("logs", {
            "timeframes": [
    ...
    def get_milestones_savings(self, days=1):
        ...
        return self.loop.run_until_complete(super()._request("milestones_savings", {"days":days}))


    def get_user_settings(self):
        """Returns user settings which are valid at the moment"""
        return self.loop.run_until_complete(super()._request("get_user_settings", {}))

    def get_injection_settings(self):
        """Shows your injection settings."""
        return self.loop.run_until_complete(super()._request("get_injection_settings", {}))

    def get_grid_mode(self):
        """Returns grid mode i.e. Offgrid mode ('island mode') or Ongrid mode"""
        return self.loop.run_until_complete(super()._request("get_grid_mode", {}))

    def check_online(self):
        """Check whether the respective SolMate is currently online."""
        return self.loop.run_until_complete(super()._request("check_online", {"serial_num": self.serialnum}))["online"]
    ...
    def set_max_injection(self, maximum_power):
        ...
        return self.loop.run_until_complete(super()._request("set_user_maximum_injection", {"injection": maximum_power}))
    ...
    def set_min_injection(self, minimum_power):
        ...
        return self.loop.run_until_complete(super()._request("set_user_minimum_injection", {"injection": minimum_power}))

    def set_min_battery_percentage(self, minimum_percentage):
        """Sets user defined minimum battery percentage"""
        return self.loop.run_until_complete(super()._request("set_user_minimum_battery_percentage", {"battery_percentage": minimum_percentage}))
    ...
    def set_AP_mode(self):
        ...
        return self.loop.run_until_complete(super()._request("revert_to_ap", {}))
...
class LocalSolMateAPIClient(AsyncLocalSolMateAPIClient):
    ...
    def list_wifis(self):
        ...
        return self.loop.run_until_complete(super().list_wifis())
    ...
    def connect_to_wifi(self, ssid, password):
        ...
        self.loop.run_until_complete(super().connect_to_wifi(ssid, password))
    ...
    def check_online(self):
        ...
        self.loop.run_until_complete(super().check_online())
